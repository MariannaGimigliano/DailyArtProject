...
public final class ActivityAppSettingsBinding implements ViewBinding {
  ...
  private ActivityAppSettingsBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView textView5, @NonNull TextView tvDeleteAccount, @NonNull TextView tvLogout) {
  ...
  public static ActivityAppSettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAppSettingsBinding((ConstraintLayout) rootView, textView5, tvDeleteAccount,
          tvLogout);
    }
